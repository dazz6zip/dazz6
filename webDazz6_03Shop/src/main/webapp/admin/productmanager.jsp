...
<table>
	...
	if (plist.isEmpty()) { // 읽어온 상품 정보가 없을 경우
		%>
		...
		<tr style="text-align: center;">
			...
			<td><%= p.getStock() %></td>
			<td>
				<a href="javascript:productDetail('<%= p.getNo() %>')">GO</a>
			</td>
		</tr>
		<%
		}
	...
	<tr style="text-align: right">
		<td colspan="6">
			<a href="productinsert.jsp" style="background-color: gray; color: white; border-radius: 10px; padding: 5px;">상품 등록</a>
		</td>
	</tr>
</table>
